...
def test_setup():
  ...
  TestName = "test_PmNotificationsElements"
  description = "This test scenario is to verify all the Elements present at PM Notifications Page"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
  TestDirectoryName = "test_PmNotificationsElements"
  global Exe
  Exe="Yes"
  ...
  if platform == "linux" or platform == "linux2":
      ...
      path = 'D:/AVER/AverTest1/' + Directory
