...
def test_ReportSendSmokeAll():
    ...
    if platform == "linux" or platform == "linux2":
        ...
        PDFpath = 'D:/AVER/AverTest1/' + Directory
    ...
    html = '''
        <html>
            <body>
                <p>Hi Team <br />Here is the test summary report of Test Suite 10 ( PM Notifications ) <br />Below test scenarios are covered </p>
                <p></p>
                <p>'''+B+'''</p
                <p></p>
    ...
    msg = MIMEMultipart()
    msg['Subject']=ctDate+" ["+ct+"]"+'-[Test Suite 10 (PM Notifications)]-Test Automation Report-Env [Test]'
    msg['From'] = email_from
