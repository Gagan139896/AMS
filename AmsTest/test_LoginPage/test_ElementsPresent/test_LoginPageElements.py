...
def test_VerifyAllClickables(test_setup):
    if Exe == "Yes":
        ...
        try:
            ...
            PageName="Logo"
            Ptitle1="https://pegaqa.crochetech.com/prweb/app/default/beEBp4uRVTogorRwSwWqbOtn9IL2fwdI*/webwb/pzpega-logo.svg"
            try:
                PageTitle1 = driver.find_element_by_xpath("//div[@class='logo-container']/img").get_attribute('src')
                print("Page title is " +PageTitle1)
            ...
            Ptitle1 = "User name"
            try:
                PageTitle1 = driver.find_element_by_xpath("//input[@id='txtUserID']").get_attribute('placeholder')
                print(PageTitle1)
                assert PageTitle1 in Ptitle1, PageName + " not able to open"
                TestResult.append(PageName + "  is present")
                TestResultStatus.append("Pass")
            ...
            Ptitle1 = "Password"
            try:
                PageTitle1 = driver.find_element_by_xpath("//input[@id='txtPassword']").get_attribute('placeholder')
                print(PageTitle1)
                assert PageTitle1 in Ptitle1, PageName + " not able to open"
                TestResult.append(PageName + "  is present")
                TestResultStatus.append("Pass")
            ...
            Ptitle1 = "Log in"
            try:
                PageTitle1 = driver.find_element_by_xpath("//button[@id='sub']/span").text
                print(PageTitle1)
                assert PageTitle1 in Ptitle1, PageName + " not able to open"
                TestResult.append(PageName + "  is present")
                TestResultStatus.append("Pass")
