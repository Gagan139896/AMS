...
def test_setup():
  ...
  TestName = "test_SkillManagElements"
  description = "This test scenario is to verify all the Elements present at Skill Management Page"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
  TestDirectoryName = "test_SkillManagElements"
  global Exe
  Exe="Yes"
