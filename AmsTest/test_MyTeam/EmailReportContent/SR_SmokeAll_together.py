...
def test_ReportSendSmokeAll():
    ...
    if platform == "linux" or platform == "linux2":
        PDFpath = '/home/legion/office 1wayit/AVER/AverTest1/' + Directory
    elif platform == "win32" or platform == "win64":
        PDFpath = 'D:/AMS/AmsTest/' + Directory

    MachineName = os.getenv('COMPUTERNAME')
    if MachineName == "DESKTOP-JLLTS65":
        PDFpath = PDFpath.replace('D:', 'C:')
    ...
    html = '''
        <html>
            <body>
                <p>Hi Team <br />Here is the test summary report of Test Suite 3 ( My Team ) <br />Below test scenarios are covered </p>
                <p></p>
                <p>'''+B+'''</p
                <p></p>
    ...
    email_from = 'AMS Test Automation Team'
    ...
    msg = MIMEMultipart()
    msg['Subject']=ctDate+" ["+ct+"]"+'-[Test Suite 3 (My Team)]- AMS Test Automation Report'
    msg['From'] = email_from
