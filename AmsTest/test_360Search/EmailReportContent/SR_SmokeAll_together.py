...
def test_ReportSendSmokeAll():
    ...
    html = '''
        <html>
            <body>
                <p>Hi Team <br />Here is the test summary report of Test Suite 4 ( Client Listing ) <br />Below test scenarios are covered </p>
                <p></p>
                <p>'''+B+'''</p
                <p></p>
    ...
    email_from = 'AMS Automation Team'
    ...
    msg = MIMEMultipart()
    msg['Subject']=ctDate+" ["+ct+"]"+'-[Test Suite 4 (Client Listing)]-Test Automation Report-Env [Test] '
    msg['From'] = email_from
