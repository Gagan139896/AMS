...
def test_setup():
  ...
  TestName = "test_MyWorkWorking"
  description = "This test scenario is to verify the Working of My Work page"
  TestResult = []
  TestResultStatus = []
  TestFailStatus = []
  FailStatus="Pass"
  TestDirectoryName = "test_MyWorkWorking"
  global Exe
  Exe="Yes"
