...
def test_ReportSendSmokeAll():
    ...
    html = '''
        <html>
            <body>
                <p>Hi Team <br />Here is the test summary report of Test Suite 4 ( My Work ) <br />Below test scenarios are covered </p>
                <p></p>
                <p>'''+B+'''</p
                <p></p>
    ...
    msg = MIMEMultipart()
    msg['Subject']=ctDate+" ["+ct+"]"+'-[Test Suite 4 (My Work)]-AMS Test Automation Report'
    msg['From'] = email_from
